...
declare let __VLS_typeProps: Omit<BFormCheckboxGroupProps, 'modelValue'>;
...
declare const __VLS_component: import('vue').DefineComponent<__VLS_PublicProps, {
    ...
    'update:modelValue': (modelValue: readonly import('../..').CheckboxValue[]) => any;
}, string, import('vue').PublicProps, Readonly<__VLS_PublicProps> & Readonly<{
    "onUpdate:modelValue"?: ((modelValue: readonly import('../..').CheckboxValue[]) => any) | undefined;
}>, {
    disabled: boolean;
