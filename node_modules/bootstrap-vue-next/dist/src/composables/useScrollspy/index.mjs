import { a as useIntersectionObserver, b as useMutationObserver } from "../../../index-DngH9Pjm.mjs";
...
import { s as syncRef } from "../../../index-DlGgXMQF.mjs";
const useScrollspy = (content, target, options = {}) => {
      ...
      if ((_a2 = node.getAttribute("href")) == null ? void 0 : _a2.includes(`#${newId}`)) {
        ...
        if (!foundParent) {
          ...
          while ((_i = parentNav == null ? void 0 : parentNav.classList) == null ? void 0 : _i.contains("nav-item")) {
            foundParent = true;
            parentNav.querySelector(".nav-link") !== activeElement && ((_j = parentNav.querySelector(".nav-link")) == null ? void 0 : _j.classList.remove("active"));
  ...
  const scrollIntoView = (event, smooth = false) => {
    ...
    if (el && resolvedContent.value) {
      resolvedContent.value.scrollTo ? resolvedContent.value.scrollTo({ top: el.offsetTop, behavior: smooth ? "smooth" : "auto" }) : resolvedContent.value.scrollTop = el.offsetTop;
    }
  };
  const cleanup = () => {
    iobs.stop();
